...
from text_face_detection_complete import * # 이파일에 있는거 다 가져다 쓰겠다. 
import pymongo
...
def insert_data(text, name):
    # myclient = pymongo.MongoClient('mongodb+srv://root:1234@cluster0.g4bac.mongodb.net/iddb?retryWrites=true&w=majority')
    # myclient = pymongo.MongoClient('mongodb+srv://root3:1234@cluster0.t73pw.mongodb.net/iddb?retryWrites=true&w=majority')
...
frm = tk.Frame(window)
frm.pack(side=tk.BOTTOM, pady=15)
...
btn = tk.Button(frm, text='종료', command=lambda: exit())
