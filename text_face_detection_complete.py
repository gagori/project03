...
def rectangle_detect(file_path, lang='kor'):
    ...
    # f = open(f'result/{file_name}.txt', w, encoding="UTF-8")
    # cv2.imwrite(f'result/{file_name}.jpg', gray_img)
    if file_name:
        cv2.imwrite(f'result/{file_name}.jpg' , gray_img)
        ...
        print(temp_filename)
        cv2.imwrite(f'result/{temp_filename}.jpg' , gray_img)
...
# named = rectangle_detect(file_path)
# print(named)

# set_image_dpi(file_path)
# new_img = process_image_for_ocr(file_path)
# print(new_img)
